...
vim.keymap.set('n', '<leader>l', '<cmd>set list!<cr>', { desc = 'Toggle whitespace' })
-- Quickfix window.
...
require('lazy').setup({
    ...
    -- Surround (overlapping keymaps with leap)
    {
    ...
    -- Git stuff.
    {
        ...
        opts = {
            ...
            on_attach = function(bufnr)
                ...
                vim.keymap.set('n', '<leader>G', showBlame,
                    { buffer = bufnr, desc = 'Show full line blame' })
                vim.keymap.set('n', '<leader>B', gs.toggle_current_line_blame,
    ...
    -- Fuzzy searching
    {
        ...
        config = function()
            ...
            vim.keymap.set('n', '<C-f>', function() tsb.current_buffer_fuzzy_find(dd) end,
                { desc = 'Grep buffer' })
        ...
        config = function()
            ...
            lsp_zero.on_attach(function(client, bufnr)
                ...
                vim.keymap.set('n', 'gD', vim.lsp.buf.declaration,
                    { buffer = bufnr, desc = 'LSP: Declaration' })
                ...
                handlers = {
                    ...
                    rust_analyzer = function()
                        ...
                        vim.api.nvim_create_autocmd({ 'BufEnter', 'BufWinEnter' }, {
                            ...
                            callback = function()
                                vim.keymap.set('n', '<leader>R', '<cmd>RustRunnables<cr>',
                                    { desc = 'Runnables' })
            ...
            vim.keymap.set('n', '<leader>F', '<cmd>ToggleFormatOnSave<cr>',
